...
EasyTcpClient::~EasyTcpClient()
{
    ...
    qDebug()<<"~EasyTcpClient():starting to close...";
    Close();
}
...
void EasyTcpClient::Close()
{
    ...
    _isConnect = false;
    qDebug()<<"EasyTcpClient is exsting thread...";
   // _thread.Close();

    Sleep(100);
    _thread.Exit();
    qDebug()<<"EasyTcpClient is exsting thread end";
}

void EasyTcpClient::OnRun()
{
   qDebug()<<"EasyTcpClient::OnRun() start";
    while (isRun())
    {
    ...
    qDebug()<<"EasyTcpClient::OnRun() end";
}
